import { Component, JSXChunk } from "@types";
import getEntryJSXChunk from "./getEntryJSXChunk";

const converter = (() => {

    let globalContent: string = "";
    let entryChunk: JSXChunk;
    ...
    const initialize = (content: string) => {
        ...
        entryChunk = getEntryJSXChunk(content.replace(/[\n\r]/g, ""));
        console.log(entryChunk);

        // chunks.forEach((chunk: JSXChunk) => {
        //     components.push(createComponent(chunk));
        // });
    }
